...
# download the mapping file from [https://github.com/arunavedula/crime_uci_ml/blob/master/state_region_mapping.xlsx]
library(readxl)
state_region_mapping <- 
  read_excel("C:/Users/Aruna/Desktop/state_region_mapping.xlsx")
